...
const sailorScouts = ["Moon", "Venus", "Mars", "Mercury", "Jupiter"]
...
pushFront(sailorScouts, "Chibi Moon");
console.log(sailorScouts);
...
insertAt(sailorScouts, 3, "Chibi Moon");
console.log(sailorScouts);
